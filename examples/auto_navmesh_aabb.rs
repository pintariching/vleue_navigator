    ...
    for _ in 0..100 {
        commands.spawn((
            ...
            Transform::from_translation(
                Vec3::new(
                    rand::random_range((-(MESH_WIDTH as f32) / 2.0)..(MESH_WIDTH as f32 / 2.0)),
                    rand::random_range((-(MESH_HEIGHT as f32) / 2.0)..(MESH_HEIGHT as f32 / 2.0)),
                    0.0,
                ) * FACTOR,
            )
            .with_rotation(Quat::from_rotation_z(rand::random_range(0.0..PI))),
        ));
    }
}
